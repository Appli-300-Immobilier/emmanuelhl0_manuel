          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/2250779283357" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center text-xs bg-green-500 text-white px-3 py-1 rounded-full hover:bg-green-600 transition-colors"><MessageCircle className="w-3 h-3 mr-1" /> WhatsApp</a>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">contact@abiimmobilier.ci</p>
                <p className="text-sm text-secondary">support@abiimmobilier.ci</p>
              </div>
            </div>
      ...
      <section className="h-[400px] bg-slate-100 grayscale hover:grayscale-0 transition-all duration-500 overflow-hidden relative border-t">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="bg-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-2 border border-slate-200">
                ...
                <span className="font-bold text-sm">Retrouvez-nous  Abidjan</span>
            </div>
        </div>
        <img 
