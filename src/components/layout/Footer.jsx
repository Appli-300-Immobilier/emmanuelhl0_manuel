...
<li>- 0703313371</li>
            <li>Email: contact@emmanuelhl0manuel.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.tiktok.com/@emmanuelhl0" target="_blank" rel="noopener noreferrer" className="p-2 bg-black text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="TikTok">
                <Video className="w-4 h-4" />
              </a>
              <a href="https://wa.me/2250779283357" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
